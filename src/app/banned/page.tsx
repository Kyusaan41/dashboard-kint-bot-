...
import { Ban, Clock, AlertTriangle, Mail, CheckCircle } from "lucide-react"
  ...
  useEffect(() => {
    ...
    const checkBanStatus = async () => {
      try {
        ...
        if (!data.banned) {
          // User is unbanned, show unbanned state
          setUnbanned(true)
          setInfo(null)
          return
        }
      ...
      <div className="relative z-10 max-w-lg w-full">
        <div className="nyx-card-glass p-8 text-center animate-slide-up">
          {unbanned ? (
            <>
              {/* Unbanned icon */}
              <div className="mx-auto w-20 h-20 rounded-full bg-gradient-to-br from-green-500/20 to-green-600/20 flex items-center justify-center mb-6 animate-pulse-purple relative">
              ...
              <div className="space-y-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
                <div className="flex items-center justify-center gap-2 text-green-300">
                  ...
                  <p className="text-lg">Votre compte a été débanni !</p>
                </div>
                ...
                <motion.button
                  ...
                  className="w-full px-6 py-3 bg-gradient-to-r from-green-600 to-green-500 text-white font-bold rounded-lg hover:from-green-700 hover:to-green-600 transition-all shadow-lg"
                >
                  Aller au Dashboard
                </motion.button>
              </div>
