...
export interface AnimeCard {
    ...
    anime: string;
    rarity: CardRarity;
    image: string; // URL de l'image (sera chargée dynamiquement depuis Jikan API)
    malId: number; // MyAnimeList Character ID pour récupérer l'image
    description: string;
    power: number; // Niveau de puissance (1-100)
}
...
export const RARITY_RATES = {
    ...
    'Mythique': 0.00,    // 0% (sauf pity à 100 tirages)
};
...
export function getRandomCardByRarity(rarity: CardRarity): AnimeCard | null {
